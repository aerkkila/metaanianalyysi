...
pars.add_argument('-m', '--muuttuja', default=LPX2019_m,
                  help='Löytyvät tiedostosta %s. Oletus on %s' %(LPX2019_t,LPX2019_m))
pars.add_argument('-s', '--tallenna', nargs='?', type=int, const=1, default=0)
args = pars.parse_args()

kaudet = { 'summer':(6,9), 'winter':(3,12), 'whole_year':(1,13) }
data0 = xr.open_dataset(LPX2019_t)[args.muuttuja]
