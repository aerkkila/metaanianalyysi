kuvat: kuvia/köppen_kartta.png kuvia/prf_ft_histog_*.png kuvia/prf_ft_laatikko_*.png kuvia/prf_kartta_mean.png kuvia/prf_maa_laatikko_*.png kuvia/prf_metaani_bar.png kuvia/prf_metaani_kartta*.png
