...
static double mannkendall(const mk_ytyyppi* y, Int pit) {
...
static float ts_kulmakerroin_yx(const mk_ytyyppi* y, const mk_xtyyppi* x, Int pit) {
...
static float ts_vakiotermi_yx(float* y, const mk_xtyyppi* x, Int pit, float kulmakerroin) {
