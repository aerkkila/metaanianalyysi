...
/* Ohjelmalla koordind.c muodostetaan ensin tiedosto koordind.bin,
   josta luetaan mikä 25km-hilan koordinaatti laitetaan mihinkin latlon-ruutuun */

// gcc muunna.c `pkg-config --libs nctietue`
