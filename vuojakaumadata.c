...
void tee_data(int luokitusnum, int lajinum, float** vuoulos, float** cdf) {
    float *osdet[kausia];
...
int main(int argc, char** argv) {
	...
	for(int lajinum=0; lajinum<lajeja; lajinum++)
	    tee_data(luokenum, lajinum, vuojako, cdf);
